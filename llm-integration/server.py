...
def get_knowledge_base()->str:
    ...
    try:
        kb_path = os.path.join(os.path.join(os.path.dirname(__file__),"data","kb.json"))
        ...
        return "Erro: Knowledge base file not found"
    except json.JSONDecodeError:
        return "Error: Invalid JSON in knowlege base file"
